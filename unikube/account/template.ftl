    ...
    <v-app>
        ...
        <v-main>
            <v-container fluid fill-height class="container--login">
                <img src="${url.resourcesPath}/img/Unikube-Logo-Icon.svg" class="logo--bottom"
                     height="40%" width="30%" contain position="bottom right"/>
                <v-row justify="center">
                    <v-col cols="10" class="text-center">
                        <v-img class="d-inline-block" src="${url.resourcesPath}/img/Unikube-Logo-H-NoShadow.svg"
                               max-width="150"></v-img>
...
<#--        </div>-->
        ...
        <div class="col-sm-6 offset-sm-3 content-area">
